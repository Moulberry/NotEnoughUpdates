...
public class StorageOverlay extends GuiElement {
    ...
    public void render() {
        ...
        GlStateManager.enableDepth();
        int translateY = storageViewSize + 18 - (inventoryStartIndex / 9 * 18 + 31);
        {
            ...
            for (int i = 0; i < 9; i++) {
                ...
                GlStateManager.pushMatrix();
                GlStateManager.translate(181 - 8, translateY, 0);
    ...
    public boolean mouseInput(int mouseX, int mouseY) {
        ...
        if (Mouse.getEventButtonState() && mouseX >= guiLeft + 388 && mouseX < guiLeft + 388 + 90 &&
            ...
            switch (buttonIndex) {
                case 0:
                    NotEnoughUpdates.INSTANCE.config.storageGUI.enableStorageGUI = false;
                    break;
                case 1:
