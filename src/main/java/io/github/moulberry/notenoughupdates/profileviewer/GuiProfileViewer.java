...
public class GuiProfileViewer extends GuiScreen {
    ...
    static {
        ...
        invNameToDisplayMap.put("personal_vault_contents", Utils.createItemStack(Items.iron_door, EnumChatFormatting.GRAY + "Personal Vault"));
    }
    ...
    private void drawExtraPage(int mouseX, int mouseY, float partialTicks) {
        ...
        Utils.renderAlignedString(EnumChatFormatting.DARK_AQUA + "Sven T4", EnumChatFormatting.WHITE.toString() + (int) wolf_boss_kills_tier_3,
                guiLeft + xStart + xOffset, guiTop + yStartBottom + yOffset * 6, 76);
        ...
        // Utils.renderAlignedString(EnumChatFormatting.DARK_RED + "Profile Created", EnumChatFormatting.WHITE.toString() + (int) 7665,
        //        guiLeft + xStart + xOffset * 2, guiTop + yStartBottom, 76);
